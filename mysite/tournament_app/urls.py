...
urlpatterns = [
    ...
    path('match/<int:tournament_pk>/<int:match_pk>/', views.match_details, name='match_details'),
    ...
    path('start_tournament/<int:pk>/', views.start_tournament, name='start_tournament'),
